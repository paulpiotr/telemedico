...
final class Version20190930201523 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE IF EXISTS public.user_id_seq');
        $this->addSql('CREATE SEQUENCE public.user_id_seq INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1');
        //ALTER SEQUENCE public.user_id_seq OWNER TO telemedico;
